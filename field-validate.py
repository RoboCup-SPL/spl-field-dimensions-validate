...
def main() -> None:
    ...
    for filename in sys.argv[1:]:
        ...
        try:
            ...
            print('Error: Found a JSON Schema violation in file {0} . Printig exception and Exiting.'.format(filename), file=sys.stderr)
            raise ಠ_ಠ
        ...
        if ("goalBoxAreaLength" in field_definitions) != ("goalBoxAreaWidth" in field_definitions):
            print('Error: field needs to contain both of "goalBoxAreaLength" and "goalBoxAreaWidth", or none of them. Error in file {0} . Exiting.'.format(filename), file=sys.stderr)
            sys.exit(1)
